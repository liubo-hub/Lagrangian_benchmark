...
def add_material_points_V2(mpm_solver: engine.mpm_solver.MPMSolver,
        ndim,
    ...
    if type(particles_to_add) is list or type(particles_to_add) is tuple:
        mpm_solver.add_cube_V2(
            lower_corner=[
                particles_to_add[0], particles_to_add[1], particles_to_add[2]] if ndim == 3 else [particles_to_add[0],
                                                                                                  particles_to_add[1]],
            cube_size=[
                particles_to_add[3], particles_to_add[4], particles_to_add[5]] if ndim == 3 else [particles_to_add[2],
                                                                                                  particles_to_add[3]],
            material=material,
            velocity=velocity)
